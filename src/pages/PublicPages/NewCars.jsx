...
const NewCars = () => {
  ...
  return (
    <div className="pt-24 pb-16 max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-primary mb-6">New Cars</h1>

      <CarFilterSidebar cars={cars} type="new">
        {(visibleCars) => (
          <>
            {loading && (
